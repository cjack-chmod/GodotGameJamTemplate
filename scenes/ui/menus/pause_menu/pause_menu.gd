...
func _close() -> void:
	...
	CustomLogger.info("Closing pause menu")
...
func _on_resume_pressed() -> void:
	CustomLogger.info("Resume button pressed")
	_close()
...
func _on_restart_pressed() -> void:
	CustomLogger.info("Restart button pressed")
	get_tree().paused = false
	ScreenTransition.transition_to_scene(ScreenTransition.main_scene_file_path)


func _on_quit_pressed() -> void:
	CustomLogger.info("Quit to main menu pressed")
	get_tree().paused = false
